...
public class tarla6Gelistir : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                deger = Convert.ToInt32(bilgiler[27]);
                break;
            }
        }
        GameObject.Find("Tahil6Gelistir").GetComponentInChildren<Text>().text = "Bu Seviyeyi Geliştir : " + (deger + 1).ToString();
    }
    public void gelistir()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                seviye = Convert.ToInt32(bilgiler[27]);
                break;
            }
            satir++;
        }
