...
public class tarla4Gelistir : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                deger = Convert.ToInt32(bilgiler[25]);
                break;
            }
        }
        GameObject.Find("Tahil4Gelistir").GetComponentInChildren<Text>().text = "Bu Seviyeyi Geliştir : " + (deger + 1).ToString();
    }
    public void gelistir()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                seviye = Convert.ToInt32(bilgiler[25]);
                break;
            }
            satir++;
        }
