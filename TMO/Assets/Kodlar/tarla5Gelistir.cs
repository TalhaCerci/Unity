...
public class tarla5Gelistir : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                deger = Convert.ToInt32(bilgiler[26]);
                break;
            }
        }
        GameObject.Find("Tahil5Gelistir").GetComponentInChildren<Text>().text = "Bu Seviyeyi Geliştir : " + (deger + 1).ToString();
    }
    public void gelistir()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                seviye = Convert.ToInt32(bilgiler[26]);
                break;
            }
            satir++;
        }
