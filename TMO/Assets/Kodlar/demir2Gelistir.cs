...
public class demir2Gelistir : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        GameObject.Find("Demir2Gelistir").GetComponentInChildren<Text>().text = "Bu Seviyeyi Geliştir : " + (deger + 1).ToString();
    }
    public void gelistir()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                seviye = Convert.ToInt32(bilgiler[11]);
                break;
            }
            satir++;
        }
