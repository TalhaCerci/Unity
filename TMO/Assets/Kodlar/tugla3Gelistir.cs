...
public class tugla3Gelistir : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                deger = Convert.ToInt32(bilgiler[20]);
                break;
            }
        }
        GameObject.Find("Tugla3Gelistir").GetComponentInChildren<Text>().text = "Bu Seviyeyi Geliştir : " + (deger + 1).ToString();
    }
    public void gelistir()
    {
        ...
        for (int i = 0; i < Lines.Length; i++)
        {
            ...
            if (bilgiler[0] == "1")
            {
                seviye = Convert.ToInt32(bilgiler[20]);
                break;
            }
            satir++;
        }
